...
# offckb resolves its data dir via XDG_DATA_HOME (under snap-confined VS Code
# terminals this is e.g. ~/snap/code/<rev>/.local/share, NOT ~/.local/share),
# so honour it here or the wipe/patch below silently targets the wrong dir.
